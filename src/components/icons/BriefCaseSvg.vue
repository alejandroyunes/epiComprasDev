<template>
  <svg width="55px" height="45px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <g id="path-2" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
      <g id="Icon-Set" sketch:type="MSLayerGroup" transform="translate(-204.000000, -204.000000)" fill="">
        <path
          ...
          id="briefcase" sketch:type="MSShapeGroup">
